...
export default function ({ title, logo, skills }) {
  return (
    <ul className="list bg-base-100 rounded-box shadow-md xl:mx-80">
      <li className="flex align-between text-lg">
        <div>
          <h1 className="text-4xl">🌌</h1>
        </div>
        <div className="flex flex-col space-y-8">
          <div>
            <div className="text-3xl">Starstuf</div>
            <div className="text-xl uppercase font-semibold opacity-60">
              3D Solar System Simulator
            </div>
          </div>
          <p className="list-col-wrap text">
